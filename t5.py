...
from transformers import pipeline, T5Tokenizer, T5ForSequenceClassification

# Explicitly load the model and tokenizer
tokenizer = T5Tokenizer.from_pretrained("michelecafagna26/t5-base-finetuned-sst2-sentiment", legacy=False)
model = T5ForSequenceClassification.from_pretrained("michelecafagna26/t5-base-finetuned-sst2-sentiment")
